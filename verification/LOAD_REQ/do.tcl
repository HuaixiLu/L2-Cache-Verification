...
assume -name issue_decode56 {(~ __START__) || (__ILA_PMESH_L2_ILA_decode_of_LOAD_REQ__)}
assume -name issue_valid57 {(~ __START__) || (__ILA_PMESH_L2_ILA_valid__)}
assume -name funcmap58 {~(`true) || (~(__IEND__)||(__unknown__0_0_result_reg==m1.state_wrap.l2_state.l2_state_array.cache[0][5:0]))}
assume -name post_value_holder59 {(~(pipe2_monitor_S2) || ((msg_data) == (m1.pipe2.dpath.msg_data_S2[63:0])))}
assume -name post_value_holder60 {(~(monitor_S4) || ((msg_send) == (m1.pipe1.ctrl.msg_send_type_S4)))}
assume -name post_value_holder61 {(~(monitor_S4) || ((msg_valid) == (m1.pipe1.ctrl.msg_send_valid_S4)))}
assume -name func_result62 {(~(__START__) || ((__unknown__0_0_result_reg) == (__unknown__0_0_result_wire)))}
...
assert -name variable_map_assert8 {(~ __IEND__) || ((~ ((__START__) ) || (`true) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m1__)))}
assert -name variable_map_assert9 {(~ __IEND__) || ((m1.pipe1.ctrl.msg_send_valid_S4))}
