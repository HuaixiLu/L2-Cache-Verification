...
assume -name start_condition56 {(~ __START__) || __ILA_PMESH_L2_ILA_decode_of_Msg2_Asserted__}
assume -name start_condition57 {(~ __START__) || m1.pipe1.ctrl.valid_S4}
...
assert -name variable_map_assert0 {(~ __IEND__) || ((~ ((__START__) ) || (`true) )&&( ~ (~(__START__)&&(__IEND__) ) || (__m1__)))}
