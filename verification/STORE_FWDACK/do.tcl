...
assume -name start_condition55 {(~ __START__) || __ILA_PMESH_L2_ILA_decode_of_STORE_FWDACK__}
assume -name start_condition56 {(~ __START__) || ((m1.pipe2.ctrl.valid_S1 && !m1.pipe2.ctrl.stall_S1) == 1)}
