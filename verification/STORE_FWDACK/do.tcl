...
assume -name start_condition53 {(~ __START__) || __ILA_PMESH_L2_ILA_decode_of_STORE_FWDACK__}
assume -name start_condition54 {(~ __START__) || ((m1.pipe2.ctrl.valid_S1 && !m1.pipe2.ctrl.stall_S1) == 1)}
...
assert -name variable_map_assert0 {(~ __IEND__) || (m1.data_wrap.l2_data.l2_data_array.cache[0][63:0] == __ILA_SO_cache_data)}
...
assert -name variable_map_assert2 {(~ __IEND__) || ((~ ((__START__) ) || (cache_in[12:11] == __ILA_SO_cache_vd) )&&( ~ (~(__START__)&&(__IEND__) ) || (m1.state_wrap.l2_state.l2_state_array.cache[0][12:11] == __ILA_SO_cache_vd)))}
assert -name variable_map_assert3 {(~ __IEND__) || (m1.mshr_wrap.state_mem_f[0] == __ILA_SO_cur_msg_state)}
