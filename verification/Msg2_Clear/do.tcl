...
assume -name issue_decode56 {(~ __START__) || (__ILA_PMESH_L2_ILA_decode_of_Msg2_Clear__)}
...
assert -name variable_map_assert0 {(~ __IEND__) || ((m1.pipe1.ctrl.msg_send_valid_S4))}
